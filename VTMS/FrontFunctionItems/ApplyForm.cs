    ...
    public partial class ApplyForm : Form
    {
        ...
        private Apply getApplyInfo()
        {
            if (!this.isUpdate)
            {
                ...
                apply.SaveDate = DateTime.ParseExact(VehicleDao.GetCurrentDate(), "yyyyMMdd", System.Globalization.CultureInfo.CurrentCulture);
            }
        ...
        private Apply getPrintInfo()
        {
            ...
            apply.PrintDate = DateTime.ParseExact(VehicleDao.GetCurrentDate(), "yyyyMMdd", System.Globalization.CultureInfo.CurrentCulture);
