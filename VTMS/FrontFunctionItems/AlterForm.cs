    ...
    public partial class AlterForm : Form
    {
        ...
        private Alter getAlterInfo()
        {
            if (!this.isUpdate)
            {
                ...
                alter.SaveDate = DateTime.ParseExact(VehicleDao.GetCurrentDate(), "yyyyMMdd", System.Globalization.CultureInfo.CurrentCulture);
            }
        ...
        private Alter getPrintInfo()
        {
            ...
            alter.PrintDate = DateTime.ParseExact(VehicleDao.GetCurrentDate(), "yyyyMMdd", System.Globalization.CultureInfo.CurrentCulture);
