    ...
    public partial class RegisterForm : Form
    {
        ...
        private Register getRegisterInfo()
        {
            if (!this.isUpdate)
            {
                ...
                register.SaveDate = DateTime.ParseExact(VehicleDao.GetCurrentDate(), "yyyyMMdd", System.Globalization.CultureInfo.CurrentCulture);
            }
        ...
        private Register getPrintInfo()
        {
            ...
            register.PrintDate = DateTime.ParseExact(VehicleDao.GetCurrentDate(), "yyyyMMdd", System.Globalization.CultureInfo.CurrentCulture);
