...
{
    public partial class PrintInfoForm : Office2007Form
    {
        ...
        public Vehicle GetVehicleInfo()
        {
            ...
            vehicle.OriginCustomer.Id = this.originId.Text;
            vehicle.CurrentCustomer.Id = this.currentId.Text;
            ...
            vehicle.PrintDate = DateTime.ParseExact(VehicleDao.GetCurrentDate(), "yyyyMMdd", System.Globalization.CultureInfo.CurrentCulture);
            vehicle.Printer = LoginForm.user.UsersId;
