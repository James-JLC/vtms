...
{
    public partial class ReTradeForm : Office2007Form
    {
        #region 初始化参数
        ...
        public Retrade GetRetradeInfo()
        {
            if (!this.isUpdate)
            {
                vehicle.Saver = LoginForm.user.UsersId;

                vehicle.SaveDate = DateTime.ParseExact(RetradeDao.GetCurrentDate(), "yyyyMMdd", System.Globalization.CultureInfo.CurrentCulture);
            }
        ...
        private void startVediaoBtn_Click(object sender, EventArgs e)
        {
            if (this.StartVideo())
            {
                ...
                this.startVediaoBtn.Enabled = false;
            }
        }
        #endregion
        ...
        private void retradeBtn_Click(object sender, EventArgs e)
        {
            ...
            _vehicle.SaveDate = DateTime.ParseExact(VehicleDao.GetCurrentDate(), "yyyyMMdd", System.Globalization.CultureInfo.CurrentCulture);
