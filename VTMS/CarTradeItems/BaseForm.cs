...
namespace VTMS.CarTradeItems
{
    public partial class BaseForm : Form
    {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual Vehicle GetVehicleInfo()
        {
            ...
            //vehicle.GrantDate = DateTime.ParseExact(VehicleDao.GetCurrentDate(), "yyyyMMdd", System.Globalization.CultureInfo.CurrentCulture);
            //vehicle.Granter = LoginForm.user.UsersId;
