...
namespace VTMS.CarTradeItems
{
    public partial class RecordForm : BaseForm
    {
        ...
        public override Vehicle GetVehicleInfo()
        {
            ...
            vehicle.RecordDate = DateTime.ParseExact(VehicleDao.GetCurrentDate(), "yyyyMMdd", System.Globalization.CultureInfo.CurrentCulture);
            vehicle.Recorder = LoginForm.user.UsersId;
