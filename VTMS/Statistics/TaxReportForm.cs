...
namespace VTMS.Statistics
{
    public partial class TaxReportForm : Office2007Form
    {
        ...
        {
            this.dataGridView.DataSource = VehicleDao.CaculateTaxReport(this.startDate.Value.Date.AddMilliseconds(-1), this.endDate.Value.Date.AddDays(1).AddMilliseconds(-1));
        }
        #endregion
        ...
        private void dataGridView_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            ...
            else if (dataGridView.Columns[e.ColumnIndex].Name == "OriginNameColumn")
            {
