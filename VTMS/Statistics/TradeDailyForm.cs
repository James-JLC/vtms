...
namespace VTMS.Statistics
{
    public partial class TradeDailyForm : Form
    {
        ...
        {
            this.dataGridView.DataSource = VehicleDao.CaculateTradeDailyReport(this.startDate.Value.Date.AddMilliseconds(-1), this.endDate.Value.Date.AddDays(1).AddMilliseconds(-1), this.dailyCondition.Text);
        }
        #endregion
        ...
        private void dataGridView_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            ...
            else if (dataGridView.Columns[e.ColumnIndex].Name == "CompanyColumn")
            {
                e.Value = vehicle.Company.Name;
            }
        }
        #endregion
    }
