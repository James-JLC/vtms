...
namespace VTMS.Statistics
{
    public partial class CompanyReportForm : Office2007Form
    {
        ...
        {
            this.dataGridView.DataSource = VehicleDao.CaculateCompanyReport(this.startDate.Value.Date.AddMilliseconds(-1), this.endDate.Value.Date.AddDays(1).AddMilliseconds(-1), this.company.SelectedValue.ToString());
        }
        #endregion
